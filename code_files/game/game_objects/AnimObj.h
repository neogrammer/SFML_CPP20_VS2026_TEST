...
public:
	...
	AnimObj(Cfg::Textures texID_, sf::IntRect texRect_, bool uniDirectional_ = false, sf::Vector2f position = { 0.f,0.f }, sf::Vector2f size = { 0.f,0.f }, sf::Vector2f offset_ = { 0.f,0.f });
