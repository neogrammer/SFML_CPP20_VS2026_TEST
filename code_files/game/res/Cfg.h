...
struct Cfg
{
	...
	// Resource Enums 
	enum class Textures : int { PlayerAtlas, BallsBG, SplashBG, TitleBG, TilesetJungle1, PLXBG1, PLXBG2, PLXBG3, PLXBG4, PLXBG5, PLXBG6, PLXBG7, PLXBG8, BlankTile, Default, Count, None };
